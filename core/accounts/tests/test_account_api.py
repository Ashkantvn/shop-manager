...
class TestAccountApi:
    ...
    def test_POST_update_account_status_401(self,worker ,authenticated_worker):
        url = reverse("accounts:update", args=[worker.user.username])
        data = {
            "start_time": "09:00",
            "end_time": "17:00",
    ...
    def test_POST_update_account_status_403(self,manager , authenticated_manager):
        url = reverse("accounts:update", args=[manager.user.username])
        data = {
            "start_time": "09:00",
            "end_time": "17:00",
        }
